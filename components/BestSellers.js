...
const bestSellers = [
  {
    ...
    images: ["/images/fig1.jpg", "/images/fig2.jpg"],
  },
  {
    id: 2,
    name: "Monstera",
    ...
    images: ["/images/monstera1.jpg", "/images/monstera2.jpg"],
  },
  {
    id: 3,
    name: "ZZ Plant",
    ...
    images: ["/images/zzplant1.jpg", "/images/zzplant2.jpg"],
  },
  {
    id: 4,
    name: "Rubber Plant",
    ...
    images: ["/images/rubber1.jpg", "/images/rubber2.jpg"],
  },
];
...
const BestSellers = () => {
  ...
  const filteredPlants = bestSellers.filter(
    (plant) =>
  ...
  return (
    <motion.section
      ...
      className="py-12 text-center bg-gray-100"
    >
      <h2 className="text-3xl font-bold text-green-700 mb-6">Best Sellers</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 container mx-auto px-4">
        {filteredPlants.map((plant) => (
          <motion.div
            ...
            className="relative p-4 bg-white shadow-md rounded-lg text-center transform hover:scale-105 transition"
          >
            {/* View Details Button */}
            <button
